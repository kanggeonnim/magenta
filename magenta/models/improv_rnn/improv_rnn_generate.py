...
from s3.upload_s3 import upload_s3
...
tf.app.flags.DEFINE_string(
    'bundle_file', settings.BUNDLE_FILE_PATH,
...
tf.app.flags.DEFINE_string(
    'output_dir', settings.MIDI_FILE_PATH,
...
def run_with_flags(generator):
  ...
  """
    ...
    for i in range(FLAGS.num_outputs):
        ...
        midi_list.append(midi_filename)
...
def main(chords):
    ...
    if FLAGS.save_generator_bundle:
        ...
        midi_list = run_with_flags(generator)
        return upload_s3(midi_list)
